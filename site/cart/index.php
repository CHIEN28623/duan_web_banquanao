  ...
  <div class="flex shadow-md my-10">
    <div class="w-3/4 bg-white px-10 py-10">
      ...
      <div class="flex mt-10 mb-5">
        ...
        <h3 class="font-semibold  text-gray-600 text-xs uppercase w-1/5 text-center">Other</h3>
      </div>
      <!-- product -->
    ...
    <div id="summary" class="w-1/4 px-8 py-10 border-l-2">
      ...
      <div>
        ...
        <select class="block p-2 border text-gray-600 w-full text-sm">
          <option>Standard - 100.000 VND</option>
        </select>
      </div>
      <div class="py-10">
